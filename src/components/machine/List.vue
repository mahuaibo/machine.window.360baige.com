<template>
  <div class="index">
    ...
    <div class="content-head">
      <el-input v-model="input" placeholder="设备编号" style="width: 120px;"></el-input>
      <el-input v-model="input" placeholder="企业名称" style="width: 120px;"></el-input>
      <el-input v-model="input" placeholder="设备状态" style="width: 120px;"></el-input>
    ...
    <div class="comtent-list" style="text-align: center;">
      <el-table :data="schoolFeeData.list" max-height="510">
        <el-table-column label="设备编号" width="160">
        ...
        <el-table-column label="物理地址" width="160">
          <template scope="scope">
...
<script>
  ...
  import ElButton from '../../../../admin.window.360baige.com/node_modules/element-ui/packages/button/src/button.vue'
